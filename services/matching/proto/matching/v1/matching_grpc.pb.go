...
const (
	MatchingEngine_LoadSnapshot_FullMethodName = "/matching.v1.MatchingEngine/LoadSnapshot"
	MatchingEngine_HealthCheck_FullMethodName  = "/matching.v1.MatchingEngine/HealthCheck"
)
...
func (c *matchingEngineClient) LoadSnapshot(ctx context.Context, in *LoadSnapshotRequest, opts ...grpc.CallOption) (*LoadSnapshotResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoadSnapshotResponse)
	err := c.cc.Invoke(ctx, MatchingEngine_LoadSnapshot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMatchingEngineServer) LoadSnapshot(context.Context, *LoadSnapshotRequest) (*LoadSnapshotResponse, error) {
...
func _MatchingEngine_LoadSnapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoadSnapshotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MatchingEngineServer).LoadSnapshot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MatchingEngine_LoadSnapshot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MatchingEngineServer).LoadSnapshot(ctx, req.(*LoadSnapshotRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _MatchingEngine_LoadSnapshot_Handler,
		},
		{
